...
Тестовая лаборатория для Enterprise WiFi с готовыми конфигурациями:
- **42 базовых конфига безопасности** (WPA1/WPA2/WPA3-Enterprise, все смешанные режимы)
- **8 конфигов для тестирования ширины каналов** (20/40/80/80+80/160/320 МГц)
...
### Базовые конфиги безопасности (`hostapd/generated/`)

**42 конфига** (21 вариант × 2 диапазона: 2.4 GHz и 5 GHz)

**Формат SSID:** `LAB-<диапазон>-<вариант>`
Примеры:
- `LAB-24-WPA2Ent-CCMP-P1` — 2.4 GHz, базовый вариант
- `LAB-5G-WPA2Ent-CCMP-P1` — 5 GHz, базовый вариант

### Конфиги ширины каналов (`hostapd/channel-widths/`)

**8 конфигов** для тестирования разных ширин каналов (используется базовый вариант безопасности WPA2Ent-CCMP-P1):

- **2.4 GHz**: 20 МГц, 40 МГц (HT40+)
- **5 GHz**: 20, 40, 80, 80+80, 160, 320 МГц

**Формат SSID:** `LAB-<диапазон>-<ширина>-<вариант>`
Примеры:
- `LAB-24-40M-WPA2Ent-CCMP-P1` — 2.4 GHz, 40 МГц
- `LAB-5G-80p80M-WPA2Ent-CCMP-P1` — 5 GHz, 80+80 МГц
- `LAB-5G-320M-WPA2Ent-CCMP-P1` — 5 GHz, 320 МГц (HE/Wi‑Fi 6E)
...
| `20M` | Ширина канала 20 МГц |
| `40M` | Ширина канала 40 МГц (HT40+ для 2.4 GHz, VHT для 5 GHz) |
| `80M` | Ширина канала 80 МГц (VHT) |
| `80p80M` | Ширина канала 80+80 МГц (VHT, два сегмента) |
| `160M` | Ширина канала 160 МГц (VHT) |
| `320M` | Ширина канала 320 МГц (HE/Wi‑Fi 6E) |
